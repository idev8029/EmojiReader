...
//  EmojiReader
//
//  Created by Назар on 24.08.2024.
//
...
class EmojiTableViewController: UITableViewController {
    ...
    var objects = [
        Emoji(emoji: "🥰", name: "Love", description: "Let's love is each other", isFavourite: false),
        Emoji(emoji: "⚽️", name: "Football", description: "Let's football together", isFavourite: false),
